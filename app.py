...
import sqlite3
from database import init_db, get_all_shelters
from rules import evaluate_safesync
...
I18N = {
    'English': {
        ...
        'offline_walkie_warn': '📶 Mobile Network Unavailable – Walkie-Talkie Mode Active',
        'hazard_config': 'Hazard Configuration',
        'hazard_type': 'Hazard Type',
        'severity_level': 'Severity Level',
        'nav_label': 'Navigation',
        'nav_dash': '1. Emergency Dashboard',
        'nav_walkie': '2. Walkie-Talkie Simulation',
        ...
        'walkie_title': '📻 Walkie-Talkie Emergency Communication Module',
        'walkie_sub': 'Software-Based Direct Radio Simulation (Mesh / Offline Peer-to-Peer)',
        'radio_ctrl': 'Radio Controls',
        'status_label': 'Status',
        'status_online': 'ONLINE (P2P READY)',
        'status_offline': 'EMERGENCY MODE (OFFLINE MESH)',
        'act_channel': 'Active Channel',
        ...
        'channels': ['Rescue Team', 'Local Volunteers', 'Nearby Users']
    },
    'Telugu': {
        ...
        'offline_walkie_warn': '📶 మొబైల్ నెట్‌వర్క్ అందుబాటులో లేదు – వాకీ-టాకీ మోడ్ సక్రియంగా ఉంది',
        'hazard_config': 'ప్రమాద ఎంపిక',
        'hazard_type': 'ప్రమాద రకం',
        'severity_level': 'తీవ్రత స్థాయి',
        'nav_label': 'నెవిగేషన్',
        'nav_dash': '1. అత్యవసర డాష్‌బోర్డ్',
        'nav_walkie': '2. వాకీ-టాకీ సిమ్యులేషన్',
        ...
        'walkie_title': '📻 వాకీ-టాకీ అత్యవసర కమ్యూనికేషన్ మాడ్యూల్',
        'walkie_sub': 'సాఫ్ట్‌వేర్ ఆధారిత రేడియో సిమ్యులేషన్ (ఆఫ్‌లైన్)',
        'radio_ctrl': 'రేడియో నియంత్రణలు',
        'status_label': 'స్థితి',
        'status_online': 'ఆన్‌లైన్',
        'status_offline': 'అత్యవసర ఆఫ్‌లైన్ మోడ్',
        'act_channel': 'ప్రస్తుత ఛానెల్',
        ...
        'btn_bcast': '📢 అత్యవసర ప్రసారం (BROADCAST)',
        ...
        'channels': ['రెస్క్యూ టీమ్', 'స్థానిక వాలంటీర్లు', 'సమీప వినియోగదారులు']
    },
    'Hindi': {
        ...
        'walkie_title': '📻 वॉकी-टॉकी आपातकालीन संचार मॉड्यूल',
        'walkie_sub': 'सॉफ्टवेयर-आधारित डायरेक्ट रेडियो सिमुलेशन (ऑफलाइन)',
        'radio_ctrl': 'रेडियो नियंत्रण',
        'status_label': 'स्थिति',
        'status_online': 'ऑनलाइन',
        'status_offline': 'आपातकालीन मोड (ऑफलाइन)',
        'act_channel': 'सक्रिय चैनल',
        ...
        'btn_bcast': '📢 आपातकालीन प्रसारण (BROADCAST)',
        ...
        'channels': ['बचाव दल', 'स्थानीय स्वयंसेवक', 'आस-पास के उपयोगकर्ता']
    },
    'Kannada': {
        ...
        'offline_walkie_warn': '📶 ಮೊಬೈಲ್ ನೆಟ್‌ವರ್ಕ್ ಲಭ್ಯವಿಲ್ಲ – ವಾಕಿ-ಟಾಕಿ ಮೋಡ್ ಸಕ್ರಿಯವಾಗಿದೆ',
        ...
        'nav_walkie': '2. ವಾಕಿ-ಟಾಕಿ ಸಿಮ್ಯುಲೇಶನ್',
        ...
        'walkie_title': '📻 ವಾಕಿ-ಟಾಕಿ ತುರ್ತು ಸಂವಹನ ಮಾಡ್ಯೂಲ್',
        'walkie_sub': 'ಸಾಫ್ಟ್‌ವೇರ್ ಆಧಾರಿತ ರೇಡಿಯೊ ಸಿಮ್ಯುಲೇಶನ್ (ಆಫ್‌ಲೈನ್)',
        'radio_ctrl': 'ರೇಡಿಯೋ ನಿಯಂತ್ರಣಗಳು',
        'status_label': 'ಸ್ಥಿತಿ',
        'status_online': 'ಆನ್‌ಲೈನ್',
        'status_offline': 'ತುರ್ತು ಆಫ್‌ಲೈನ್ ಮೋಡ್',
        'act_channel': 'ಸಕ್ರಿಯ ಚಾನೆಲ್',
        ...
        'btn_bcast': '📢 ತುರ್ತು ಪ್ರಸಾರ (BROADCAST)',
        ...
        'mobility_opts': {'Normal': 'ಸಾಮಾನ್ಯ', 'Limited Mobility': 'ಪರಿಮಿತ ಚಲನಶೀಲತೆ', 'Wheelchair': 'ವೀಲ್‌ಚೇರ್'},
        'channels': ['ರಕ್ಷಣಾ ತಂಡ', 'ಸ್ಥानीय ಸ್ವಯಂಸೇವಕರು', 'ಸಮೀಪದ ಬಳಕೆದಾರರು']
    },
    'Tamil': {
        ...
        'offline_walkie_warn': '📶 மொபைல் நெட்வொர்க் இல்லை – வாக்கி-டாக்கி முறை செயல்படுகிறது',
        ...
        'nav_walkie': '2. வாக்கி-டாக்கி உருவகப்படுத்துதல்',
        ...
        'walkie_title': '📻 வாக்கி-டாக்கி அவசரக்கால தகவல் தொடர்பு தொகுதி',
        'walkie_sub': 'மென்பொருள் அடிப்படையிலான ரேடியோ உருவகப்படுத்துதல் (ஆஃப்லைன்)',
        'radio_ctrl': 'ரேடியோ கட்டுப்பாடுகள்',
        'status_label': 'நிலை',
        'status_online': 'ஆன்லைன்',
        'status_offline': 'அவசரக்கால ஆஃப்லைன் முறை',
        'act_channel': 'செயலில் உள்ள சேனல்',
        ...
        'btn_bcast': '📢 அவசர ஒலிபரப்பு (BROADCAST)',
        ...
        'channels': ['மீட்புக் குழு', 'உள்ளூர் தன்னார்வலர்கள்', 'அருகிலுள்ள பயனர்கள்']
    }
}
...
st.sidebar.markdown("---")
nav_options = [T['nav_dash'], T['nav_walkie'], T['nav_watch']]
...
eval_res = evaluate_safesync(st.session_state['hazard_type'], st.session_state['severity'], user_profile, shelters)
...
if nav == T['nav_dash']:
    ...
    with col_b:
        ...
        if not st.session_state['offline_mode'] and not st.session_state['low_battery_mode']:
            m = folium.Map(location=[16.3067, 80.4365], zoom_start=13)
            folium.Marker([16.3067, 80.4365], popup="Location (Red Zone)", icon=folium.Icon(color="red")).add_to(m)
            if rec_shelter:
                folium.Marker([rec_shelter['lat'], rec_shelter['lon']], popup=f"Shelter: {rec_shelter['name']}", icon=folium.Icon(color="green")).add_to(m)
                folium.PolyLine([[16.3067, 80.4365], [rec_shelter['lat'], rec_shelter['lon']]], color="blue", weight=3, opacity=0.8).add_to(m)
...
# --- PAGE 2: WALKIE-TALKIE SIMULATION ---
    ...
    with w_col1:
        ...
        if st.button(T['btn_bcast'], use_container_width=True):
            msg = f"CRITICAL SOS: {st.session_state['name']}"
            st.session_state['walkie_history'].append({"sender": "SYSTEM BROADCAST", "text": msg, "channel": channel})
            speak_text(msg, current_lang_code)
            st.rerun()
    ...
    with w_col2:
        ...
        for msg in reversed(st.session_state['walkie_history']):
            if msg['channel'] == channel or msg['sender'] == "SYSTEM BROADCAST":
...
# --- PAGE 3: SMARTWATCH SIMULATION ---
    ...
    with w_col:
        watch_bg = "#330000" if eval_res['risk_zone'] == "Red Zone" else "#021A00"
        border_color = "#FF0000" if eval_res['risk_zone'] == "Red Zone" else "#00FF00"
        ...
        st.markdown(f"""
            <div style="width:280px; height:340px; background:{watch_bg}; border:8px solid {border_color}; border-radius:40px; padding:18px; margin:auto; text-align:center; color:#fff; font-family:sans-serif;">
                ...
                <div style="font-size:0.8rem; color:#ffaa00; margin-top:4px;">{T['metric_risk']}: {eval_res['risk_score']}</div>
